  ...
  const projects = [
    {
      ...
      type: "SaaS Platform",
      category: "Full-Stack",
      description: "Interactive storytelling platform with modern UI/UX and user authentication",
    ...
    },
    {
      ...
      type: "SaaS Platform",
      category: "Full-Stack",
      description: "AI-powered development hub with smart features and subdomain support",
      technologies: ["Next.js", "tRPC", "Drizzle", "AWS"],
    },
    {
      id: "zero-deploy",
      image: "/project7.png",
      ...
      category: "DevOps",
      description: "Automated deployment platform for web applications with containerization",
      technologies: ["Docker", "AWS", "Kubernetes", "CI/CD"],
    },
    {
      id: "zero-authenticate",
      image: "/project5.png",
      name: "ZERO | AUTHENTICATE",
      type: "Backend Service",
      category: "Backend",
      description: "Secure authentication system with modern OAuth and JWT features",
      technologies: ["Node.js", "JWT", "OAuth", "Express.js"],
    },
    {
      id: "zero-campus",
      image: "/project6.png",
      ...
      category: "Full-Stack",
      description: "Campus management system with real-time features and comprehensive tools",
      technologies: ["MERN Stack", "Socket.io", "Redux", "MongoDB"],
    },
  ]
