    ...
    <div className="min-h-screen bg-gradient-to-br from-black-1 via-black-2 to-black-1">
      <main>
        ...
        <div className="md:hidden pt-4 px-2">
          <div className="flex justify-between items-center p-4 bg-gradient-to-r from-black-6/80 to-black-2/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white-3/10">
            <Link href="/">
        ...
        <div className="pt-32 max-md:pt-8">{children}</div>
